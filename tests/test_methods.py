...
#
#
# def test_calculate_tdc_peptide(tmp_path):
#     dataframe = pd.DataFrame(
#         {
#             # "sequence": ["ABC", "ABC", "DEF", "DEF", "GHI", "GHI", "JKL", "JKL", "MNO", "MNO"],
#             "sequence": ["MESCSVAQAGVLTSPFMWR", "MESCSVAQAGVLTSPFMWR", "MESAMTFGPCVWVALSSQR", "MESAMTFGPCVWVALSSQR",
...
#         "target/decoy",
#     )
#     # psm_result, peptide_result = calculate_tdc(dataset)
#     # print(psm_result.data)
#     # print(dataset.results.get("psm")[0].data)
#     # print(peptide_result.data)
#     # print(dataset.results.get("peptide")[0].data)
#     path = os.path.join(tmp_path, "test.txt")
#     dataframe.to_csv(path)
#     datasetTEST = read_file(path, "sequence", "scan", "combined p-value", "target/decoy", fasta="C:/Users/donav/OneDrive/Desktop/mztabfiles/human_sp_td.fasta.txt")
#     psm_result, peptide_result = calculate_tdc(datasetTEST)
#     print(datasetTEST.results.get("psm")[0].data)
#     print(datasetTEST.results.get("peptide")[0].data)
#     # print(len(datasetTEST.protein_map))
#     # print(datasetTEST.protein_map)
#     # dataset.write_results(output_dir="C:/Users/donav/Onedrive/Desktop")
#     # dataset2 = read_file(["C:/Users/donav/Onedrive/Desktop/target.txt", "C:/Users/donav/Onedrive/Desktop/target.txt"])
#     # psm_result2, peptide_result2 = calculate_tdc(dataset2)
#     # print(psm_result2.data)
#     # print(peptide_result2.data)
#     # psm_result2.write_file(output_dir="C:/Users/donav/Onedrive/Desktop", file_root="psm")
#     # psm_result2.write_file(output_dir="C:/Users/donav/Onedrive/Desktop", file_root="peptide")
