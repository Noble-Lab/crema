...
def test_competition_target_wins_spectrum():
    ...
    psms = _make_psms([
        {"file": "f1", "scan": 1, "score": 0.9, "target": True,  "peptide": "AAA", "protein": "P1"},
        {"file": "f1", "scan": 1, "score": 0.1, "target": False, "peptide": "AXA", "protein": "P1"},
        {"file": "f1", "scan": 2, "score": 0.2, "target": True,  "peptide": "BBB", "protein": "P2"},
        {"file": "f1", "scan": 2, "score": 0.8, "target": False, "peptide": "BXB", "protein": "P2"},
    ])
...
def test_competition_decoy_wins_spectrum():
    ...
    psms = _make_psms([
        {"file": "f1", "scan": 1, "score": 0.9, "target": False, "peptide": "AXA", "protein": "P1"},
        {"file": "f1", "scan": 1, "score": 0.1, "target": True,  "peptide": "AAA", "protein": "P1"},
        {"file": "f1", "scan": 2, "score": 0.8, "target": True,  "peptide": "BBB", "protein": "P2"},
        {"file": "f1", "scan": 2, "score": 0.2, "target": False, "peptide": "BXB", "protein": "P2"},
    ])
    conf = psms.assign_confidence(
        score_column="score", method="tdc", desc=True,
        pep_fdr_type="psm-only", threshold="q-value",
...
def test_competition_multiple_candidates_per_spectrum():
    ...
    psms = _make_psms([
        {"file": "f1", "scan": 1, "score": 0.5, "target": True,  "peptide": "AA", "protein": "P1"},
        {"file": "f1", "scan": 1, "score": 0.9, "target": True,  "peptide": "BB", "protein": "P1"},
        {"file": "f1", "scan": 1, "score": 0.3, "target": False, "peptide": "XY", "protein": "P1"},
        # Second spectrum so we have at least one decoy surviving
        {"file": "f1", "scan": 2, "score": 0.2, "target": False, "peptide": "CC", "protein": "P2"},
        {"file": "f1", "scan": 2, "score": 0.1, "target": True,  "peptide": "DD", "protein": "P2"},
    ])
    conf = psms.assign_confidence(
        score_column="score", method="tdc", desc=True,
        pep_fdr_type="psm-only", threshold="q-value",
...
def test_shared_peptide_excluded_from_proteins():
    ...
    psms = _make_psms([
        ...
        {"file": "f1", "scan": 1, "score": 0.9, "target": True,  "peptide": "AAA", "protein": "P1,P2"},
        {"file": "f1", "scan": 1, "score": 0.1, "target": False, "peptide": "AXA", "protein": "P1,P2"},
        # Peptide maps to one protein → included
        {"file": "f1", "scan": 2, "score": 0.8, "target": True,  "peptide": "BBB", "protein": "P3"},
        {"file": "f1", "scan": 2, "score": 0.2, "target": False, "peptide": "BXB", "protein": "P3"},
    ])
    conf = psms.assign_confidence(
        score_column="score", method="tdc", desc=True,
        pep_fdr_type="psm-only", threshold="q-value",
...
def test_all_targets_raises():
    ...
    df = pd.DataFrame([
        {"file": "f1", "scan": 1, "score": 0.9, "target": True, "peptide": "AA", "protein": "P1"},
        {"file": "f1", "scan": 2, "score": 0.8, "target": True, "peptide": "BB", "protein": "P2"},
    ])
...
def test_all_decoys_raises():
    ...
    df = pd.DataFrame([
        {"file": "f1", "scan": 1, "score": 0.9, "target": False, "peptide": "AX", "protein": "P1"},
        {"file": "f1", "scan": 2, "score": 0.8, "target": False, "peptide": "BX", "protein": "P2"},
    ])
